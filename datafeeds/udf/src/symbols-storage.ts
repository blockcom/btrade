...
export class SymbolsStorage {
	...
	//private readonly _exchangesList: string[] = ['BCH','ETH','XRP','ETC'];
	private readonly _exchangesList: string[] = ['BTC','ETH','DASH','LTC','ETC','XRP','BCH','XMR','ZEC','QTUM'];
